...
std::vector<const char *> to_char_array(
...
vfile *vec_open_simple(const std::vector<std::string> &paths, int flag,
                       mode_t mode);
vfile *vec_open(const std::vector<std::string> &paths, std::vector<int> &flags,
                std::vector<mode_t> &modes);
vres vec_hardlink(const std::vector<std::string> &src,
                  const std::vector<std::string> &dest, bool is_trans);
vres vec_symlink(const std::vector<std::string> &src,
                 const std::vector<std::string> &dest, bool is_trans);
